...
class SettingsActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        contactSupport.setOnClickListener{
            ...
            contactSupportIntent.putExtra(Intent.EXTRA_EMAIL, arrayOf(getString(R.string.default_email)))
            contactSupportIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.email_default_subject))
